missing_code = """
                ...
                AnimatedVisibility(visible = attachedMediaName != null) {
                    Surface(
                ...
                Row(
                    ...
                    Box(modifier = Modifier.weight(1f)) {
                        if (inputText.isEmpty() && !isRecordingVoice) {
                            Text(
                                text = if (attachedMediaName != null) "Ketik instruksi media..." else "Pesan FinMonochrome AI...",
                            ...
                            keyboardActions = KeyboardActions(
                                onSend = {
                                    if ((inputText.isNotBlank() || attachedMediaName != null) && !isAiLoading) {
                                        ...
                                        onSendMessage(query, mediaName, mediaType)
                                    }
                                }
                            )
                        )
                    ...
                    // Voice / Send Button
                    if (inputText.isBlank() && attachedMediaName == null) {
                        IconButton(
                            onClick = {
